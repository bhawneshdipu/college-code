...
set nf [open 665_go_back.nam w]
$ns namtrace-all $nf
proc finish {} {
        global ns nf
        $ns flush-trace
        close $nf
        exec nam 665_go_back.nam & 
        exit 0
}
...
$ns at 0.0 "$cbr start"
$ns at 0.1 "$cbr stop"
$ns at 0.0 "$ns trace-annotate \"frame0 start at 0.1 cbr \""

$ns at 0.1 "$cbr1 start"
$ns at 0.2 "$cbr1 stop"
$ns at 0.1 "$ns trace-annotate \"frame1 start at 0.2  cbr1\""

$ns at 0.2 "$cbr4 start"
$ns at 0.3 "$cbr4 stop"
$ns at 0.2 "$ns trace-annotate \"frame 3 start at 0.5 cbr4\""


$ns at 0.3 "$cbrn start"
$ns at 0.4 "$cbrn stop"
$ns at 0.3 "$ns trace-annotate \"n ack  lost start at 0.3 cbrn\""


$ns at 0.4 "$cbr2 start"
$ns at 0.5 "$cbr2 stop"
$ns at 0.4 "$ns trace-annotate \"frame2 start at 0.3  cbr2\""



$ns at 0.5 "$cbr3 start"
$ns at 0.6 "$cbr3 stop"
$ns at 0.5 "$ns trace-annotate \"frame2 start at 0.4 cbr3\""

$ns at 0.6 "$cbr4 start"
$ns at 0.7 "$cbr4 stop"
$ns at 0.6 "$ns trace-annotate \"frame 3 start at 0.5 cbr4\""

$ns at 0.7 "$cbr5 start"
$ns at 0.8 "$cbr5 stop"
$ns at 0.7 "$ns trace-annotate \"ACK1 start at 0.5 cbr5\""
