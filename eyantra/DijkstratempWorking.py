...
def dijkstra(G,start,end,hor,ver):
	print "x=",start.x, "y=",start.y,"dis=",start.dis,"visit=",start.visited;
#	print "y=",start.y;
#	print "dis=",start.dis;
#	print start.path;
	...
	if(start.y<5 ):
			if(hor[start.x][start.y]==1):
				...
				print start.x,"  ",start.y," ",start.dis,"horizontal ",start.x,"  ",start.y+1," ",G[start.x][start.y+1].dis;
	...
	if(start.x<5):	
		if(ver[start.x][start.y]==1):
				...
				if(dist<NN.dis):
					...
					G[start.x][start.y].path=pth1;
				print start.x,"  ",start.y," ",start.dis,"vertical ",start.x+1,"  ",start.y," ",G[start.x+1][start.y].dis;
	...
	if(start.x>0 and start.y<5):
		if(ver[start.x-1][start.y]==1):
			...
			if(dist<NN.dis):
				...
				G[start.x-1][start.y].path=pth;
				G[start.x][start.y].path=pth1;
			print start.x,"  ",start.y," ",start.dis,"vertical neg ",start.x-1,"  ",start.y," ",G[start.x-1][start.y].dis
	...
	if(start.y>0 and start.x<5):
		if(ver[start.x][start.y-1]==1):
			...
			if(dist<NN.dis):
				...
				G[start.x][start.y-1].path=pth;
				G[start.x][start.y].path=pth1;
			print start.x,"  ",start.y," ",start.dis,"horizontal neg ",start.x,"  ",start.y-1," ",G[start.x][start.y-1].dis
			if(G[start.x][start.y-1].visited==False):
				dijkstra(G,G[start.x][start.y-1],end,hor,ver);
