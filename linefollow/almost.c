...
int main(void)
{
	...
	DDRC=0b00000000;
	PORTC=0b00000001;
	int lm,l,m,r,rm,ps,flag=0,lc=0,rc=0,diff=0,flagend=0,f=0;
    while (1)
    {
		lm=PINC & 0b00000001;
		l=PINC & 0b00000010;
		...
		}else if(ps==FALSE && lm==LM_T && l==FALSE && m==FALSE && r==FALSE && rm==RM_T ){
			...
			if(f==0){
				...
				switch(diff){
					...
					case 1:_delay_ms(1000);
							break;
					case 2:_delay_ms(2000);
							break;
					case 3:_delay_ms(3000);
							break;
					case 4:_delay_ms(4000);
							break;
				}
